package filterlibrary.glfilter.resource;

import filterlibrary.glfilter.color.bean.DynamicColor;
import filterlibrary.glfilter.color.bean.DynamicColorBaseData;
import filterlibrary.glfilter.color.bean.DynamicColorData;
import filterlibrary.glfilter.effect.bean.DynamicEffect;
import filterlibrary.glfilter.effect.bean.DynamicEffectData;
import filterlibrary.glfilter.makeup.bean.DynamicMakeup;
import filterlibrary.glfilter.makeup.bean.MakeupBaseData;
import filterlibrary.glfilter.makeup.bean.MakeupLipstickData;
import filterlibrary.glfilter.makeup.bean.MakeupMaterialData;
import filterlibrary.glfilter.makeup.bean.MakeupNormaData;
import filterlibrary.glfilter.makeup.bean.MakeupType;
import filterlibrary.glfilter.stickers.bean.DynamicSticker;
import filterlibrary.glfilter.stickers.bean.DynamicStickerData;
