...
import library.cameralibrary.camera.CameraParam;
import library.cameralibrary.loader.impl.CameraMediaLoader;
import library.cameralibrary.model.GalleryType;
import library.cameralibrary.presenter.CameraPreviewPresenter;
import library.cameralibrary.widget.PartyTextureView;
import library.cameralibrary.widget.CameraMeasureFrameLayout;
import library.cameralibrary.widget.CameraPreviewTopbar;
import library.cameralibrary.widget.PreviewMeasureListener;
import library.cameralibrary.widget.RecordButton;
import library.cameralibrary.widget.RecordCountDownView;
import library.cameralibrary.widget.RecordProgressView;
import library.cameralibrary.widget.RecordSpeedLevelBar;
import zhihai.partycamera_e1.R;
import library.pickerlibrary.MediaPicker;
import library.pickerlibrary.loader.AlbumDataLoader;
import library.pickerlibrary.model.AlbumData;
import library.utilslibrary.bean.MusicData;
import library.utilslibrary.dialog.DialogBuilder;
import library.utilslibrary.fragment.MusicPickerFragment;
import library.utilslibrary.fragment.PermissionErrorDialogFragment;
import library.utilslibrary.utils.BrightnessUtils;
import library.utilslibrary.utils.PermissionUtils;
import library.utilslibrary.widget.RoundOutlineProvider;
import library.widgetlibrary.widget.CameraTabView;
...
public class CameraPreviewFragment extends Fragment implements View.OnClickListener, LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private PartyTextureView mCameraTextureView;
    // fps显示
    ...
    private void initPreviewSurface() {
        ...
        mCameraTextureView = new PartyTextureView(mActivity);
...
//        });
    ...
    // ------------------------------- TextureView 滑动、点击回调 ----------------------------------
    private PartyTextureView.OnTouchScroller mTouchScroller = new PartyTextureView.OnTouchScroller() {
     ...
     * 单双击回调监听
     */
    private PartyTextureView.OnMultiClickListener mMultiClickListener = new PartyTextureView.OnMultiClickListener() {
