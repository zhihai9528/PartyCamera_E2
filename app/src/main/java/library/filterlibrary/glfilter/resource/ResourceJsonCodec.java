package library.filterlibrary.glfilter.resource;

import library.filterlibrary.glfilter.color.bean.DynamicColor;
import library.filterlibrary.glfilter.color.bean.DynamicColorBaseData;
import library.filterlibrary.glfilter.color.bean.DynamicColorData;
import library.filterlibrary.glfilter.effect.bean.DynamicEffect;
import library.filterlibrary.glfilter.effect.bean.DynamicEffectData;
import library.filterlibrary.glfilter.makeup.bean.DynamicMakeup;
import library.filterlibrary.glfilter.makeup.bean.MakeupBaseData;
import library.filterlibrary.glfilter.makeup.bean.MakeupLipstickData;
import library.filterlibrary.glfilter.makeup.bean.MakeupMaterialData;
import library.filterlibrary.glfilter.makeup.bean.MakeupNormaData;
import library.filterlibrary.glfilter.makeup.bean.MakeupType;
import library.filterlibrary.glfilter.stickers.bean.DynamicSticker;
import library.filterlibrary.glfilter.stickers.bean.DynamicStickerData;
import library.filterlibrary.glfilter.stickers.bean.DynamicStickerFrameData;
import library.filterlibrary.glfilter.stickers.bean.DynamicStickerNormalData;
import library.filterlibrary.glfilter.stickers.bean.StaticStickerNormalData;
